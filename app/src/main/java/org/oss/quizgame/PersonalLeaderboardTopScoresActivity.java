...
public class PersonalLeaderboardTopScoresActivity extends AppCompatActivity {
    FirebaseAuth mAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChildren()) {
                    ...
                    Collections.sort(personalLeaderboardScores, (score1, score2) -> Integer.compare(score2.getScore(), score1.getScore()));
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(PersonalLeaderboardTopScoresActivity.this, "Error: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        logout.setOnClickListener(view -> {
            mAuth.signOut();
            Toast.makeText(PersonalLeaderboardTopScoresActivity.this, "Successful logout", Toast.LENGTH_SHORT).show();
            startActivity(new Intent(PersonalLeaderboardTopScoresActivity.this, LoginActivity.class));
        });
    }
}